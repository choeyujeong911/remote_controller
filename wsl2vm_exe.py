...
def initialize_cpu_sampling(root_process):
    for proc in get_process_tree(root_process):
        try:
...
def get_process_tree_usage(root_process):
    total_cpu = 0.0
    total_memory = 0
...
def execute_workload(package, client):
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        print(
            f"[WSL2] Process finished "
            f"(exit={process.returncode})"
        )

        print(
            f"[WSL2] Execution Time: "
